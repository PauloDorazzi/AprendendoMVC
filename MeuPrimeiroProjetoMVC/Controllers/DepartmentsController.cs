...
namespace MeuPrimeiroProjetoMVC.Controllers
{
    ...
    {
        private readonly MeuPrimeiroProjetoMVCContext _context;

        public DepartmentsController(MeuPrimeiroProjetoMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Department != null ? 
                          ...
                          Problem("Entity set 'MeuPrimeiroProjetoMVCContext.Department'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MeuPrimeiroProjetoMVCContext.Department'  is null.");
            }
            var department = await _context.Department.FindAsync(id);
            if (department != null)
            {
